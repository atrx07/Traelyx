...
part of 'bootstrap_v1_database.dart';
...
abstract class _$BootstrapV1Database extends GeneratedDatabase {
  _$BootstrapV1Database(QueryExecutor e) : super(e);
  $BootstrapV1DatabaseManager get managers => $BootstrapV1DatabaseManager(this);
...
class $$AppSettingsTableFilterComposer
    extends Composer<_$BootstrapV1Database, $AppSettingsTable> {
...
typedef $$AppSettingsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (
        AppSetting,
        BaseReferences<_$BootstrapV1Database, $AppSettingsTable, AppSetting>,
      ),
      AppSetting,
      PrefetchHooks Function()
    >;

class $BootstrapV1DatabaseManager {
  final _$BootstrapV1Database _db;
  $BootstrapV1DatabaseManager(this._db);
