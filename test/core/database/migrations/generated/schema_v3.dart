...
class TripAccountLinks extends Table
    with TableInfo<TripAccountLinks, TripAccountLinksData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  TripAccountLinks(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> tripId = GeneratedColumn<String>(
    'trip_id',
    aliasedName,
    false,
  ...
  @override
  TripAccountLinksData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TripAccountLinksData(
      tripId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}trip_id'],
      )!,
  ...
  @override
  TripAccountLinks createAlias(String alias) {
    return TripAccountLinks(attachedDatabase, alias);
  }
...
class TripAccountLinksData extends DataClass
    implements Insertable<TripAccountLinksData> {
  final String tripId;
  final String userId;
  final int consentedAtMicros;
  final int summaryVersion;
  const TripAccountLinksData({
    required this.tripId,
  ...
  factory TripAccountLinksData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  @override
  String toString() {
    return (StringBuffer('TripAccountLinksData(')
          ..write('tripId: $tripId, ')
          ..write('userId: $userId, ')
...
class TripAccountLinksCompanion extends UpdateCompanion<TripAccountLinksData> {
  final Value<String> tripId;
  ...
  TripAccountLinksCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       consentedAtMicros = Value(consentedAtMicros),
       summaryVersion = Value(summaryVersion);
  static Insertable<TripAccountLinksData> custom({
    Expression<String>? tripId,
...
class AccountMetadataCache extends Table
    with TableInfo<AccountMetadataCache, AccountMetadataCacheData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  AccountMetadataCache(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> userId = GeneratedColumn<String>(
    'user_id',
    aliasedName,
    false,
  ...
  @override
  AccountMetadataCache createAlias(String alias) {
    return AccountMetadataCache(attachedDatabase, alias);
  }
...
class DatabaseAtV3 extends GeneratedDatabase {
  ...
  late final TripAccountLinks tripAccountLinks = TripAccountLinks(this);
  late final AccountMetadataCache accountMetadataCache = AccountMetadataCache(
    this,
  );
