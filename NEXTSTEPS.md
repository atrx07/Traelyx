...
M4.1 completed on 2026-08-21. Stop at the numbered-substep approval gate; M4.2 remains pending explicit maintainer authorization.

## P0 — Approval gate

1. Await explicit maintainer authorization before activating or preparing M4.2.
...
1. Merge adjacent M4.1 analysis windows into coherent maneuver-level events.
2. Add versioned debounce/cooldown rules without hiding short severe or limited evidence.
3. Preserve peak/source provenance, confidence limitations, and stable machine IDs through merging.
