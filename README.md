...
Milestone M0 and roadmap substeps M1.1–M1.2 are complete. M1 remains active and is stopped at the approval gate before M1.3 local settings. Trip recording remains intentionally unavailable.
